...
if (seconds_to_hms(65625)   != '18:13:45')                echo "FAIL 12\n";
if (seconds_to_hms(0)       != '00:00:00')                echo "FAIL 13\n";
if (seconds_to_hms(86399)   != '23:59:59')                echo "FAIL 14\n";
if (seconds_to_hms(2987.53) != '0:49:47.53')              echo "FAIL 15\n";

if (parse_duration('4h') != 14400)                        echo "FAIL 16\n";

if (!is_duration('2d'))                                   echo "FAIL 17\n";
if (is_duration('abc'))                                   echo "FAIL 18\n";
if (is_duration('1a2d'))                                  echo "FAIL 19\n";
if (!is_duration( 500 ))                                  echo "FAIL 20\n";

if ( sql_date(ts('2011-05-08')) != '2011-05-08')          echo "FAIL 21\n";
if ( sql_date(ts('20110508')) != '2011-05-08')            echo "FAIL 22\n";
