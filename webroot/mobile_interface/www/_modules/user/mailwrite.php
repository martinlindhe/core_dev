...
?>
<body onload="TC_Init();" style="background: #FFF; padding-left: 6px;">
<style type="text/css">
#text_container {
...
<table cellspacing="0" width="99%" style="" class="cnti">
<tr>
...
<tr><td class="pdg" colspan="3"><div style="height: 100%; background: #FFF; border: 1px solid #999;"><iframe id="text_var" name="text_var" border="0" frameborder="0" width="100%" height="250"></iframe></div></td></tr>
</table>
</td></tr>
<tr>
...
<script type="text/javascript"><?=($error)?'alert(\''.$error.'\');':'';?></script>
</form>
</body>
</html>