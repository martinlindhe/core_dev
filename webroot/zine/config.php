<?
	...
	$config['database_1']['database'] = 'dbZine';
	...
	$config['login_sha1_key'] = 'sitecode_Zine';	//used to encode passwords in database, to make brute forcing them more difficult
	$config['session_name'] = 'ZINEsessID';	//name of session-id cookie
	$config['session_timeout'] = 3600*3;
	
	$config['start_page'] = '/zine/';
