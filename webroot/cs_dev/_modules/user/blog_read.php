<?
	$res = $db->getOneRow('SELECT main_id, status_id, user_id, blog_title, blog_date, blog_cmt, hidden_id, blog_visit, blog_cmts FROM s_userblog WHERE main_id = "'.secureINS($key).'" LIMIT 1');
