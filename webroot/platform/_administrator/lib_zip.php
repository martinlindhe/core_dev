...
// --------------------------------------------------------------------------------
  ...
  define( 'PCLZIP_TEMPORARY_DIR', '/ins5436/' );
...
// --------------------------------------------------------------------------------
  ...
  function privCheckFileHeaders(&$p_local_header, &$p_central_header)
  {
	...
	$p_local_header['filename_len'] = (!empty($p_local_header['filename_len']))?$p_local_header['filename_len']:0;
	$p_central_header['filename_len'] = (!empty($p_central_header['filename_len']))?$p_central_header['filename_len']:0;
