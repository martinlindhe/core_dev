...
?>
 ...
 - <em>inl&auml;gg skrivet <?=niceDate($r['sent_date'])?></em> (#<?=$r['main_id']?>)</span><?=(!$r['user_read'])?' <b>[oläst]</b>':'';?></td></tr>
				<tr>
					<td style="width: 100%;"><?='<table cellspacing="0"><tr><td>'.$user->getimg($r['id_id'].$r['u_picid'].$r['u_picd'].$r['u_sex'], $r['u_picvalid'], 0).'</td><td style="padding-left: 5px;"><div style="width: 470px; overflow: hidden;">'.secureOUT($r['sent_cmt']).'</div></td></tr></table>';?></td>
