<?
	...
	if (!$rule || $rule['deletedBy']) {
		...
		if ($rule['deletedBy']) echo '<span style="background-color:#FF6666">Error:</span> This rule has been deleted by '.$session->getUserName($rule['deletedBy']).' at '.$rule['timeDeleted'].'.<br/><br/>';
