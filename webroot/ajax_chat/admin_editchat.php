<?
	...
	if (!empty($_POST['roomname'])) {
		setChatRoomName($db, $roomId, $_POST['roomname']);
	}
	...
	echo 'Chat room was created by '.getUserName($db, $room['createdBy']).' at '.getDateStringShort($room['timeCreated']).'<br><br>';
