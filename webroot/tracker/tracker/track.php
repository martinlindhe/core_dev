<?
	//CRAP- detta är rester efter implementation hos telge.se. vi gav dom fel URL och detta är en fix
	// 		om telge slutar som kund så skrota denna fil! detta är en kopia av ../track.php, med ändrad path till include_lite.php
