<?
	...
	if (isset($_GET['empty_thumbnailcache'])) {
		$cmd = $config['system_delete'].' '.escapeshellarg($config['thumbs_dir']);
		exec($cmd);
		JS_Alert('Thumbnail cache has been cleared!');
	}
	...
	include('design_user_head.php');
		...
		$content = getInfoField($db, 'page_admindb');
		...
		echo MakeBox('<a href="admin.php">Administrationsgr&auml;nssnitt</a>|Databasen', $content);
		echo '</div>';
