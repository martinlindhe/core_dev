...
<HEAD>
	...
	<?php echo "<TITLE>Confirm grouping changes help - $phpbttracker_id $phpbttracker_ver</TITLE>\r\n"; ?>
</HEAD>
<BODY CLASS="help">
	<P CLASS="help_title"><?php echo "$phpbttracker_id $phpbttracker_ver - Confirm grouping changes help"; ?></P>
	
	This page displays the selected items from the Advanced Sorting page.<BR><BR>

	Ensure the selections are correct (providing the group to add the torrents to if necessary) and click on the <I>Confirm and process</I>
	button, or click on the hyperlink to return to the Advanced Sorting page.
</BODY>
</HTML>