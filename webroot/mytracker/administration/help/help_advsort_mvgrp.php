...
<HEAD>
	...
	<?php echo "<TITLE>Move group help - $phpbttracker_id $phpbttracker_ver</TITLE>\r\n"; ?>
</HEAD>
<BODY CLASS="help">
	<P CLASS="help_title"><?php echo "$phpbttracker_id $phpbttracker_ver - Move torrent group help"; ?></P>
	
	This page asks you where to move the group to in the list.<BR><BR>

	Choose the new location for the group and click the <I>Move group</I> button, otherwise click the link to return to the Advanced Sorting
	page.
</BODY>
</HTML>