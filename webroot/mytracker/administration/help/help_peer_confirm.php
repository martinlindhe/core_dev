<?php
	...
	/*
	 * Module:	help_peer_confirm.php
	 * Description: This module displays help for the peer confirm operation screen.
	 *
	 * Author:	danomac
...
<HEAD>
	...
	<?php echo "<TITLE>Confirm peer operation help - $phpbttracker_id $phpbttracker_ver</TITLE>\r\n"; ?>
</HEAD>
<BODY CLASS="help">
	<P CLASS="help_title"><?php echo "$phpbttracker_id $phpbttracker_ver - Confirm peer operation help"; ?></P>
	
	This page shows the items selected from the peer summary page.<BR><BR>

	It will list who you have chosen to ban and/or remove. <B>If you are banning someone ensure you add a reason in the box provided!</B>
	If everything is correct, click the <B>Confirm and process</B> button to proceed, or use the <B>Return to Peer Details screen</B> hyperlink
	to return without making any changes.</BODY>
</HTML>