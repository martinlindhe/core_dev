...
CREATE TABLE tblBlogs (
  ...
  ratingCnt int(10) unsigned default NULL,
  PRIMARY KEY  (blogId)
) ENGINE=MyISAM AUTO_INCREMENT=60 DEFAULT CHARSET=utf8;
CREATE TABLE tblCategories (
  categoryId bigint(20) unsigned NOT NULL auto_increment,
  categoryName varchar(200) default NULL,
  categoryType tinyint(3) unsigned default NULL,
  timeCreated datetime default NULL,
  creatorId int(10) unsigned default NULL,
  categoryPermissions tinyint(3) unsigned default NULL,
  ownerId bigint(20) unsigned default NULL,
  PRIMARY KEY  (categoryId)
) ENGINE=MyISAM AUTO_INCREMENT=33 DEFAULT CHARSET=utf8;
CREATE TABLE tblComments (
  commentId bigint(20) unsigned NOT NULL auto_increment,
  commentType tinyint(3) unsigned default NULL,
  commentText text,
  commentPrivate tinyint(4) default NULL,
  timeCreated datetime default NULL,
  timeDeleted datetime default NULL,
  deletedBy smallint(5) unsigned default NULL,
  ownerId bigint(20) unsigned default NULL,
  userId smallint(5) unsigned default NULL,
  userIP bigint(20) unsigned default NULL,
  PRIMARY KEY  (commentId)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;
CREATE TABLE tblContacts (
  contactId int(10) unsigned NOT NULL auto_increment,
  contactType tinyint(3) unsigned default NULL,
...
CREATE TABLE tblFiles (
  ...
  uploaderIP bigint(20) unsigned default NULL,
  fileType tinyint(3) unsigned default NULL,
...
CREATE TABLE tblGuestbooks (
  ...
  body text,
  entryDeleted tinyint(3) unsigned default NULL,
  timeDeleted datetime default NULL,
  entryRead tinyint(3) unsigned default NULL,
...
CREATE TABLE tblLogs (
  entryId mediumint(8) unsigned NOT NULL auto_increment,
  entryText text,
  entryLevel tinyint(3) unsigned default NULL,
  timeCreated datetime default NULL,
  userId smallint(5) unsigned default NULL,
...
CREATE TABLE tblModerationQueue (
  ...
  queueType tinyint(3) unsigned default NULL,
  itemId int(10) unsigned default NULL,
  timeCreated datetime default NULL,
  creatorId int(10) unsigned default NULL,
  moderatedBy int(10) unsigned default NULL,
  timeModerated datetime default NULL,
  autoTriggered tinyint(3) unsigned default NULL,
  PRIMARY KEY  (queueId)
...
CREATE TABLE tblNews (
  ...
  body text,
  rss_enabled tinyint(3) unsigned default NULL,
  creatorId int(10) unsigned default NULL,
  timeCreated datetime default NULL,
  timeEdited datetime default NULL,
...
CREATE TABLE tblSettings (
  ...
  settingValue text,
  settingType tinyint(3) unsigned default NULL,
...
CREATE TABLE tblStatistics (
  ...
  registrations int(10) unsigned default NULL,
  PRIMARY KEY  (entryId)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE tblStopwords (
  wordId smallint(5) unsigned NOT NULL auto_increment,
  wordText varchar(200) default NULL,
  wordType tinyint(3) unsigned default NULL,
  wordMatch tinyint(3) unsigned default NULL,
  PRIMARY KEY  (wordId)
...
CREATE TABLE tblUserdata (
  ...
  allowTags tinyint(3) unsigned default NULL,
  private tinyint(3) unsigned default NULL,
  fieldPriority tinyint(3) unsigned default NULL,
  regRequire tinyint(3) unsigned default NULL,
  PRIMARY KEY  (fieldId)
...
CREATE TABLE tblUsers (
  ...
  userMode tinyint(4) default NULL,
  timeCreated datetime default NULL,
  timeLastLogin datetime default NULL,
  timeLastActive datetime default NULL,
  timeLastLogout datetime default NULL,
...
CREATE TABLE tblWiki (
  ...
  timeCreated datetime default NULL,
  createdBy smallint(5) unsigned default NULL,
  lockedBy smallint(5) unsigned default NULL,
  timeLocked datetime default NULL,
  hasFiles tinyint(3) unsigned default NULL,
  PRIMARY KEY  (wikiId)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;
DELIMITER ;;
DELIMITER ;
