			...
			<tr>
				<td>
Besökte sidan från nyhetsbrevet <a href="send.php?t&show=<?=$r['main_id']?>"><?=secureOUT('VECKA '.$r['n_week'].' - '.$r['n_cmt'])?></a> med e-postadressen: <b class="txt_chead"><?=secureOUT($row['unique_id'])?></b> <?=niceDate($row['date_cnt'])?>.
				</td>
			</tr>
			<tr>
