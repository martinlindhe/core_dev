...
#include "ISXEQVanguard.h"

// The mandatory pre-setup function.  Our name is "ISXEQVanguard", and the class is ISXEQVanguard.
...
// our instanced class.
ISXPreSetup("ISXEQVanguard",ISXEQVanguard);
...
unsigned int ISXEQVanguardXML=0;
...
bool ISXEQVanguard::Initialize(ISInterface *p_ISInterface)
{	pISInterface=p_ISInterface;
	...
	WriteChatf("ISXEQVanguard Loaded");
	return true;
}

// shutdown sequence
void ISXEQVanguard::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQVanguardXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQVanguardXML);
...
void ISXEQVanguard::ConnectServices()
{
...
void ISXEQVanguard::RegisterCommands()
{
	// add any commands
...
void ISXEQVanguard::RegisterAliases()
{
	// add any aliases
}

void ISXEQVanguard::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQVanguard::UnRegisterCommands()
{
	// remove commands
//	pISInterface->RemoveCommand("MyCommand");
}
void ISXEQVanguard::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQVanguard::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQVanguard::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
//	pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQVanguard::UnRegisterServices()
{
	// shutdown our own services
//	if (hISXEQVanguardService)
//		pISInterface->ShutdownService(this,hISXEQVanguardService);
}

void ISXEQVanguard::LoadSettings()
{
	bool bChanged=false;

	// open the settings file, and store the ID number in ISXEQVanguardXML
	ISXEQVanguardXML=pISInterface->OpenSettings(XMLFileName);
...
Any set can be referred to by its ID.  The base set is stored in ISXEQVanguardXML.  Note that the settings
...
*/
	...
	if (unsigned int GeneralGUID=pISInterface->FindSet(ISXEQVanguardXML,"General"))
	{
